...
const RequestCard = ({ id, name, avatar_path, score, skills }: IRequestCardProps) => {
    return (
        <Card className="min-w-72 w-72 flex flex-col gap-4">
            <header className="flex gap-4 items-center">
                <Avatar name={name} imageUrl={avatar_path} className="shrink-0" />
                <Information name={name} skills={skills} score={score} />
            </header>
