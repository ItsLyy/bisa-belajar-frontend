...
const NavItem = ({ name, icon, url }: INavItem) => {
    ...
    return (
        <Link href={url} className={`px-1 py-4 text-nowrap flex items-center gap-4 text-app-300/60 hover:text-app-300 transition-colors ease-in-out duration-300 ${isActive ? 'text-app-500': 'text-app-300/60'}`}>
